...
#     make -f $SRC/mk/gen/ls.mk TOOLDIR=... install
#
...
ls.o: $(SRC)/usr/src/cmd/ls.c $(INCDIR)/grp.h $(INCDIR)/ndir.h $(INCDIR)/pwd.h $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ls.c
