...
#     make -f $SRC/mk/gen/dc.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/dc -I$(INCDIR)
...
dc: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o dc $(OBJS) $(LIBC)

dc.o: $(SRC)/usr/src/cmd/dc/dc.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/dc/dc.h $(TOOLS)
