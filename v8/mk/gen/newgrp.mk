...
#     make -f $SRC/mk/gen/newgrp.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/newgrp -I$(INCDIR)
...
newgrp: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o newgrp $(OBJS) $(LIBC)

newgrp.o: $(SRC)/usr/src/cmd/newgrp/newgrp.c $(INCDIR)/grp.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/newgrp/newgrp.c

install: newgrp
	-mkdir $(DESTDIR)/bin
	cp newgrp $(DESTDIR)/bin/newgrp
