...
#     make -f $SRC/mk/gen/expr.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I. -I$(SRC)/usr/src/cmd/expr -I$(SRC)/usr/src/cmd/bs -I$(INCDIR)
...
expr: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o expr $(OBJS) $(LIBC)

y.tab.c: $(SRC)/usr/src/cmd/expr/expr.y $(YACCPATH) $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/expr/regexp.h
	$(YACC) $(SRC)/usr/src/cmd/expr/expr.y
...
install: expr
	...
	cp expr $(DESTDIR)/usr/bin/expr

clean:
	-rm -f $(OBJS) expr y.tab.c
