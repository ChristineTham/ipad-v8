...
#     make -f $SRC/mk/gen/primes.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/primes -I$(INCDIR)
...
primes: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o primes $(OBJS) $(LIBC)

primes.o: $(SRC)/usr/src/cmd/primes/primes.c $(TOOLS)
