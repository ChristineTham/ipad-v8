...
#     make -f $SRC/mk/gen/sdiff.mk TOOLDIR=... install
#
...
sdiff: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o sdiff $(OBJS) $(LIBC)

sdiff.o: $(SRC)/usr/src/cmd/sdiff.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
