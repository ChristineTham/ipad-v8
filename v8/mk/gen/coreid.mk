...
#     make -f $SRC/mk/gen/coreid.mk TOOLDIR=... install
#
...
coreid: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o coreid $(OBJS) $(LIBC)

coreid.o: $(SRC)/usr/src/cmd/coreid.c $(INCDIR)/errno.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/dmap.h $(INCDIR)/sys/param.h $(INCDIR)/sys/pcb.h $(INCDIR)/sys/types.h $(INCDIR)/sys/user.h $(INCDIR)/sys/vtimes.h $(TOOLS)
