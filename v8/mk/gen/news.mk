...
#     make -f $SRC/mk/gen/news.mk TOOLDIR=... install
#
...
news: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o news $(OBJS) $(LIBC)

news.o: $(SRC)/usr/src/cmd/news.c $(INCDIR)/pwd.h $(INCDIR)/setjmp.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
