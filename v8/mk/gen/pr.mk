...
#     make -f $SRC/mk/gen/pr.mk TOOLDIR=... install
#
...
pr: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o pr $(OBJS) $(LIBC)

pr.o: $(SRC)/usr/src/cmd/pr.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/pr.c

install: pr
	-mkdir $(DESTDIR)/bin
	cp pr $(DESTDIR)/bin/pr
