...
#     make -f $SRC/mk/gen/mkfs.mk TOOLDIR=... install
#
...
mkfs.o: $(SRC)/usr/src/cmd/mkfs.c $(INCDIR)/a.out.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/fblk.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/mkfs.c
