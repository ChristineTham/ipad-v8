...
#     make -f $SRC/mk/gen/chmod.mk TOOLDIR=... install
#
...
chmod.o: $(SRC)/usr/src/cmd/chmod.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/chmod.c
