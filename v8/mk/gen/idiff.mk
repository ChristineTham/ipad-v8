...
#     make -f $SRC/mk/gen/idiff.mk TOOLDIR=... install
#
...
idiff: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o idiff $(OBJS) $(LIBC)

idiff.o: $(SRC)/usr/src/cmd/idiff.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
