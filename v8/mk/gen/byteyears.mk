...
#     make -f $SRC/mk/gen/byteyears.mk TOOLDIR=... install
#
...
byteyears: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o byteyears $(OBJS) $(LIBC)

byteyears.o: $(SRC)/usr/src/cmd/byteyears.c $(INCDIR)/ftw.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
