...
#     make -f $SRC/mk/gen/who.mk TOOLDIR=... install
#
...
who: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o who $(OBJS) $(LIBC)

who.o: $(SRC)/usr/src/cmd/who.c $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/who.c

install: who
	-mkdir $(DESTDIR)/bin
	cp who $(DESTDIR)/bin/who
