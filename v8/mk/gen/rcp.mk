...
#     make -f $SRC/mk/gen/rcp.mk TOOLDIR=... install
#
...
rcp: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o rcp $(OBJS) $(LIBC)

rcp.o: $(SRC)/usr/src/cmd/rcp.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
