...
#     make -f $SRC/mk/gen/ul.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/ul -I$(INCDIR)
...
ul: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libtermcap.a
	$(CC) $(CFLAGS) -o ul $(OBJS) $(DESTDIR)/usr/lib/libtermcap.a $(LIBC)

ul.o: $(SRC)/usr/src/cmd/ul/ul.c $(INCDIR)/stdio.h $(TOOLS)
