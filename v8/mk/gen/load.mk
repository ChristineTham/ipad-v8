...
#     make -f $SRC/mk/gen/load.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/load -I$(INCDIR)
...
load: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o load $(OBJS) $(LIBC)

load.o: $(SRC)/usr/src/cmd/load/load.c $(INCDIR)/nlist.h $(INCDIR)/stdio.h $(TOOLS)
