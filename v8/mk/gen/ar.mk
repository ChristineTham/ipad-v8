...
#     make -f $SRC/mk/gen/ar.mk TOOLDIR=... install
#
...
ar.o: ar.c $(INCDIR)/ar.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) ar.c

install: ar
	-mkdir $(TOOLDIR)/bin
	cp ar $(TOOLDIR)/bin/ar
