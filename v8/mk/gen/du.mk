...
#     make -f $SRC/mk/gen/du.mk TOOLDIR=... install
#
...
du: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o du $(OBJS) $(LIBC)

du.o: $(SRC)/usr/src/cmd/du.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/du.c

install: du
	-mkdir $(DESTDIR)/bin
	cp du $(DESTDIR)/bin/du
