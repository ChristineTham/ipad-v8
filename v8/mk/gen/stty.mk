...
#     make -f $SRC/mk/gen/stty.mk TOOLDIR=... install
#
...
stty.o: $(SRC)/usr/src/cmd/stty.c $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/stty.c
