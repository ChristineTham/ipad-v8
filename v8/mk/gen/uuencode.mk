...
#     make -f $SRC/mk/gen/uuencode.mk TOOLDIR=... install
#
...
uuencode: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o uuencode $(OBJS) $(LIBC)

uuencode.o: $(SRC)/usr/src/cmd/uuencode.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
