...
#     make -f $SRC/mk/gen/tar.mk TOOLDIR=... install
#
...
tar: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o tar $(OBJS) $(LIBC)

tar.o: $(SRC)/usr/src/cmd/tar.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/mtio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/tar.c

install: tar
	-mkdir $(DESTDIR)/bin
	cp tar $(DESTDIR)/bin/tar
