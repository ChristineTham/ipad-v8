...
#     make -f $SRC/mk/gen/uudecode.mk TOOLDIR=... install
#
...
uudecode: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o uudecode $(OBJS) $(LIBC)

uudecode.o: $(SRC)/usr/src/cmd/uudecode.c $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
