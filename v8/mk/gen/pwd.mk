...
#     make -f $SRC/mk/gen/pwd.mk TOOLDIR=... install
#
...
pwd: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o pwd $(OBJS) $(LIBC)

pwd.o: $(SRC)/usr/src/cmd/pwd.c $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/pwd.c

install: pwd
	-mkdir $(DESTDIR)/bin
	cp pwd $(DESTDIR)/bin/pwd
