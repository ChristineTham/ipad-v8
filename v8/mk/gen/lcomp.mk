...
#     make -f $SRC/mk/gen/lcomp.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/lcomp -I$(INCDIR)
COMPILE = $(CC) $(CFLAGS) $(INCS) -c
TOOLS  = $(CCPATH) $(CCOM) $(CPP) $(C2) $(AS)

OBJS = bb.o lprint.o nexit.o

all: lcomp

lcomp: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o lcomp $(OBJS) $(LIBC)

bb.o: $(SRC)/usr/src/cmd/lcomp/bb.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/lcomp/instr.c $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/lcomp/bb.c

lprint.o: $(SRC)/usr/src/cmd/lcomp/lprint.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/lcomp/lprint.c

nexit.o: $(SRC)/usr/src/cmd/lcomp/nexit.c $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/lcomp/nexit.c

install: lcomp
	-mkdir $(DESTDIR)/usr/bin
	cp lcomp $(DESTDIR)/usr/bin/lcomp
