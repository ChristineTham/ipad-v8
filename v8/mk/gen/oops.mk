...
#     make -f $SRC/mk/gen/oops.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/oops -I$(INCDIR)
...
oops: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libjobs.a
	$(CC) $(CFLAGS) -o oops $(OBJS) $(DESTDIR)/usr/lib/libjobs.a $(LIBC)

oops.o: $(SRC)/usr/src/cmd/oops/oops.c $(INCDIR)/ctype.h $(INCDIR)/errno.h $(INCDIR)/ftw.h $(INCDIR)/math.h $(INCDIR)/nlist.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/dmap.h $(INCDIR)/sys/param.h $(INCDIR)/sys/pcb.h $(INCDIR)/sys/proc.h $(INCDIR)/sys/pte.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/text.h $(INCDIR)/sys/types.h $(INCDIR)/sys/user.h $(INCDIR)/sys/vlimit.h $(INCDIR)/sys/vm.h $(INCDIR)/sys/vmmac.h $(INCDIR)/sys/vmmeter.h $(INCDIR)/sys/vmparam.h $(INCDIR)/sys/vmsystm.h $(INCDIR)/sys/vtimes.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/oops/oops.c

install: oops
	-mkdir $(DESTDIR)/bin
	cp oops $(DESTDIR)/bin/oops
