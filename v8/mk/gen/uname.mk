...
#     make -f $SRC/mk/gen/uname.mk TOOLDIR=... install
#
...
uname: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o uname $(OBJS) $(LIBC)

uname.o: $(SRC)/usr/src/cmd/uname.c $(INCDIR)/ipnx.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/uname.c

install: uname
	-mkdir $(DESTDIR)/bin
	cp uname $(DESTDIR)/bin/uname
