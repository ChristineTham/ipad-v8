...
#     make -f $SRC/mk/gen/pstat.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/pstat -I$(INCDIR)
...
pstat: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o pstat $(OBJS) $(LIBC)

pstat.o: $(SRC)/usr/src/cmd/pstat/pstat.c $(INCDIR)/errno.h $(INCDIR)/nlist.h $(INCDIR)/signal.h $(INCDIR)/sys/conf.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/dmap.h $(INCDIR)/sys/file.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/map.h $(INCDIR)/sys/param.h $(INCDIR)/sys/pcb.h $(INCDIR)/sys/proc.h $(INCDIR)/sys/pte.h $(INCDIR)/sys/text.h $(INCDIR)/sys/types.h $(INCDIR)/sys/user.h $(INCDIR)/sys/vm.h $(INCDIR)/sys/vmmac.h $(INCDIR)/sys/vmmeter.h $(INCDIR)/sys/vmparam.h $(INCDIR)/sys/vmsystm.h $(INCDIR)/sys/vtimes.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/pstat/pstat.c

install: pstat
	-mkdir $(DESTDIR)/etc
	cp pstat $(DESTDIR)/etc/pstat
