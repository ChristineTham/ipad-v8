...
#     make -f $SRC/mk/gen/spell.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/spell -I$(INCDIR)
COMPILE = $(CC) $(CFLAGS) $(INCS) -c
TOOLS  = $(CCPATH) $(CCOM) $(CPP) $(C2) $(AS)

OBJS = hash.o hashcheck.o hashlook.o hashmake.o huff.o spellin.o spellprog.o

all: spell

spell: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o spell $(OBJS) $(LIBC)

hash.o: $(SRC)/usr/src/cmd/spell/hash.c $(SRC)/usr/src/cmd/spell/hash.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/spell/hash.c

hashcheck.o: $(SRC)/usr/src/cmd/spell/hashcheck.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/spell/hash.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/spell/hashcheck.c

hashlook.o: $(SRC)/usr/src/cmd/spell/hashlook.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/spell/hash.h $(SRC)/usr/src/cmd/spell/huff.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/spell/hashlook.c

hashmake.o: $(SRC)/usr/src/cmd/spell/hashmake.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/spell/hash.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/spell/hashmake.c

huff.o: $(SRC)/usr/src/cmd/spell/huff.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/spell/huff.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/spell/huff.c

spellin.o: $(SRC)/usr/src/cmd/spell/spellin.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/spell/hash.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/spell/spellin.c

spellprog.o: $(SRC)/usr/src/cmd/spell/spellprog.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/spell/spellprog.c

install: spell
	-mkdir $(DESTDIR)/usr/bin
	cp spell $(DESTDIR)/usr/bin/spell
