...
#     make -f $SRC/mk/gen/cu.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/cu -I$(INCDIR)
...
cu: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o cu $(OBJS) $(LIBC)

cu.o: $(SRC)/usr/src/cmd/cu/cu.c $(INCDIR)/ctype.h $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
