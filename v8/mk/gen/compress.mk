...
#     make -f $SRC/mk/gen/compress.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/compress -I$(INCDIR)
...
compress: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o compress $(OBJS) $(LIBC)

compress.o: $(SRC)/usr/src/cmd/compress/compress.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
