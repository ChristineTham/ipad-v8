...
#     make -f $SRC/mk/gen/ipnxfetch.mk TOOLDIR=... install
#
...
ipnxfetch: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o ipnxfetch $(OBJS) $(LIBC)

ipnxfetch.o: $(SRC)/usr/src/cmd/ipnxfetch.c $(INCDIR)/a.out.h $(INCDIR)/ipnx.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
