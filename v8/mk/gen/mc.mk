...
#     make -f $SRC/mk/gen/mc.mk TOOLDIR=... install
#
...
mc: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o mc $(OBJS) $(LIBC)

mc.o: $(SRC)/usr/src/cmd/mc.c $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
