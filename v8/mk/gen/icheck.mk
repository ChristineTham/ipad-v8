...
#     make -f $SRC/mk/gen/icheck.mk TOOLDIR=... install
#
...
icheck.o: $(SRC)/usr/src/cmd/icheck.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/fblk.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/icheck.c
