...
#     make -f $SRC/mk/gen/dskcpy.mk TOOLDIR=... install
#
...
dskcpy: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o dskcpy $(OBJS) $(LIBC)

dskcpy.o: $(SRC)/usr/src/cmd/dskcpy.c $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/dskcpy.c

install: dskcpy
	-mkdir $(DESTDIR)/etc
	cp dskcpy $(DESTDIR)/etc/dskcpy
