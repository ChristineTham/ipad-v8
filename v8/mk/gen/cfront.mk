...
#     make -f $SRC/mk/gen/cfront.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/cfront -I$(INCDIR)
...
cfront: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o cfront $(OBJS) $(LIBC)

munch.o: $(SRC)/usr/src/cmd/cfront/munch.c $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/cfront/munch.c

install: cfront
	-mkdir $(DESTDIR)/usr/bin
	cp cfront $(DESTDIR)/usr/bin/cfront
