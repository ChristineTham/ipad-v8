...
#     make -f $SRC/mk/gen/init.mk TOOLDIR=... install
#
...
init.o: $(SRC)/usr/src/cmd/init.c $(INCDIR)/setjmp.h $(INCDIR)/signal.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/reboot.h $(INCDIR)/sys/types.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/init.c
