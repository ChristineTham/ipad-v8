...
#     make -f $SRC/mk/gen/clri.mk TOOLDIR=... install
#
...
clri: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o clri $(OBJS) $(LIBC)

clri.o: $(SRC)/usr/src/cmd/clri.c $(INCDIR)/signal.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/clri.c

install: clri
	-mkdir $(DESTDIR)/etc
	cp clri $(DESTDIR)/etc/clri
