...
#     make -f $SRC/mk/gen/w.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/w -I$(INCDIR)
...
w: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o w $(OBJS) $(LIBC)

w.o: $(SRC)/usr/src/cmd/w/w.c $(INCDIR)/ctype.h $(INCDIR)/errno.h $(INCDIR)/nlist.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/dmap.h $(INCDIR)/sys/param.h $(INCDIR)/sys/pcb.h $(INCDIR)/sys/proc.h $(INCDIR)/sys/pte.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/sys/user.h $(INCDIR)/sys/vm.h $(INCDIR)/sys/vmmac.h $(INCDIR)/sys/vmmeter.h $(INCDIR)/sys/vmparam.h $(INCDIR)/sys/vmsystm.h $(INCDIR)/sys/vtimes.h $(INCDIR)/time.h $(INCDIR)/utmp.h $(TOOLS)
