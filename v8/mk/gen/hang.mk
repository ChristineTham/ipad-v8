...
#     make -f $SRC/mk/gen/hang.mk TOOLDIR=... install
#
...
hang: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o hang $(OBJS) $(LIBC)

hang.o: $(SRC)/usr/src/cmd/hang.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/pioctl.h $(TOOLS)
