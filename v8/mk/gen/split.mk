...
#     make -f $SRC/mk/gen/split.mk TOOLDIR=... install
#
...
split: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o split $(OBJS) $(LIBC)

split.o: $(SRC)/usr/src/cmd/split.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
