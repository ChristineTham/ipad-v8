...
#     make -f $SRC/mk/gen/group.mk TOOLDIR=... install
#
...
group: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o group $(OBJS) $(LIBC)

group.o: $(SRC)/usr/src/cmd/group.c $(INCDIR)/grp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/group.c
