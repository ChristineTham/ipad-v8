...
#     make -f $SRC/mk/gen/nmount.mk TOOLDIR=... install
#
...
nmount: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libin.a
	$(CC) $(CFLAGS) -o nmount $(OBJS) $(DESTDIR)/usr/lib/libin.a $(LIBC)

nmount.o: $(SRC)/usr/src/cmd/nmount.c $(INCDIR)/errno.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/inet/in.h $(INCDIR)/sys/inet/tcp.h $(INCDIR)/sys/inet/tcp_user.h $(INCDIR)/sys/neta.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/nmount.c

install: nmount
	-mkdir $(DESTDIR)/etc
	cp nmount $(DESTDIR)/etc/nmount
