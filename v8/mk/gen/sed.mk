...
#     make -f $SRC/mk/gen/sed.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/sed -I$(INCDIR)
...
sed: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o sed $(OBJS) $(LIBC)

sed0.o: $(SRC)/usr/src/cmd/sed/sed0.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/sed/sed.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/sed/sed0.c

sed1.o: $(SRC)/usr/src/cmd/sed/sed1.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/sed/sed.h $(TOOLS)
