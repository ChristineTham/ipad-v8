...
#     make -f $SRC/mk/gen/bc.mk TOOLDIR=... install
#
...
bc: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o bc $(OBJS) $(LIBC)

y.tab.c: $(SRC)/usr/src/cmd/bc.y $(YACCPATH) $(INCDIR)/stdio.h
	$(YACC) $(SRC)/usr/src/cmd/bc.y
