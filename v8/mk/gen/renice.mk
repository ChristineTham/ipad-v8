...
#     make -f $SRC/mk/gen/renice.mk TOOLDIR=... install
#
...
renice: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o renice $(OBJS) $(LIBC)

renice.o: $(SRC)/usr/src/cmd/renice.c $(INCDIR)/errno.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/pioctl.h $(INCDIR)/sys/proc.h $(INCDIR)/sys/types.h $(INCDIR)/sys/vtimes.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/renice.c

install: renice
	-mkdir $(DESTDIR)/etc
	cp renice $(DESTDIR)/etc/renice
