...
#     make -f $SRC/mk/gen/mkstr.mk TOOLDIR=... install
#
...
mkstr: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o mkstr $(OBJS) $(LIBC)

mkstr.o: $(SRC)/usr/src/cmd/mkstr.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
