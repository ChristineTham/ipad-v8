...
#     make -f $SRC/mk/gen/mkbitfs.mk TOOLDIR=... install
#
...
mkbitfs.o: $(SRC)/usr/src/cmd/mkbitfs.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/mkbitfs.c
