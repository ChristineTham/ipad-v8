...
#     make -f $SRC/mk/gen/quot.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/quot -I$(INCDIR)
...
quot: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o quot $(OBJS) $(LIBC)

quot.o: $(SRC)/usr/src/cmd/quot/quot.c $(INCDIR)/ctype.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/quot/quot.c

install: quot
	-mkdir $(DESTDIR)/etc
	cp quot $(DESTDIR)/etc/quot
