...
#     make -f $SRC/mk/gen/cron.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/cron -I$(INCDIR)
...
cron: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o cron $(OBJS) $(LIBC)

cron.o: $(SRC)/usr/src/cmd/cron/cron.c $(INCDIR)/ctype.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/time.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/cron/cron.c

install: cron
	-mkdir $(DESTDIR)/etc
	cp cron $(DESTDIR)/etc/cron
