...
#     make -f $SRC/mk/gen/file.mk TOOLDIR=... install
#
...
file: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o file $(OBJS) $(LIBC)

file.o: $(SRC)/usr/src/cmd/file.c $(INCDIR)/a.out.h $(INCDIR)/ctype.h $(INCDIR)/pagsiz.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
