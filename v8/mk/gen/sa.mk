...
#     make -f $SRC/mk/gen/sa.mk TOOLDIR=... install
#
...
sa: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o sa $(OBJS) $(LIBC)

sa.o: $(SRC)/usr/src/cmd/sa.c $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/acct.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/sa.c

install: sa
	-mkdir $(DESTDIR)/etc
	cp sa $(DESTDIR)/etc/sa
