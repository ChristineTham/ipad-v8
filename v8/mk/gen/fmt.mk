...
#     make -f $SRC/mk/gen/fmt.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/fmt -I$(INCDIR)
...
fmt: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o fmt $(OBJS) $(LIBC)

fmt.o: $(SRC)/usr/src/cmd/fmt/fmt.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/fmt/fmt.c

head.o: $(SRC)/usr/src/cmd/fmt/head.c $(INCDIR)/local.h $(INCDIR)/setjmp.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(SRC)/usr/src/cmd/fmt/def.h $(SRC)/usr/src/cmd/fmt/glob.h $(SRC)/usr/src/cmd/fmt/rcv.h $(TOOLS)
