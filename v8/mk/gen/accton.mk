...
#     make -f $SRC/mk/gen/accton.mk TOOLDIR=... install
#
...
accton: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o accton $(OBJS) $(LIBC)

accton.o: $(SRC)/usr/src/cmd/accton.c $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/accton.c

install: accton
	-mkdir $(DESTDIR)/etc
	cp accton $(DESTDIR)/etc/accton
