...
#     make -f $SRC/mk/gen/mt.mk TOOLDIR=... install
#
...
mt: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o mt $(OBJS) $(LIBC)

mt.o: $(SRC)/usr/src/cmd/mt.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/mtio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/mt.c

install: mt
	-mkdir $(DESTDIR)/bin
	cp mt $(DESTDIR)/bin/mt
