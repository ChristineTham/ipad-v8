...
#     make -f $SRC/mk/gen/procmount.mk TOOLDIR=... install
#
...
procmount: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o procmount $(OBJS) $(LIBC)

procmount.o: $(SRC)/usr/src/cmd/procmount.c $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/procmount.c

install: procmount
	-mkdir $(DESTDIR)/etc
	cp procmount $(DESTDIR)/etc/procmount
