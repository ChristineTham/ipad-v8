...
#     make -f $SRC/mk/gen/tp.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/tp -I$(INCDIR)
...
tp: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o tp $(OBJS) $(LIBC)

tp0.o: $(SRC)/usr/src/cmd/tp/tp0.c $(SRC)/usr/src/cmd/tp/tp.h $(SRC)/usr/src/cmd/tp/tp_defs.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/tp/tp0.c

tp1.o: $(SRC)/usr/src/cmd/tp/tp1.c $(SRC)/usr/src/cmd/tp/tp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/tp/tp1.c

tp2.o: $(SRC)/usr/src/cmd/tp/tp2.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(SRC)/usr/src/cmd/tp/tp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/tp/tp2.c

tp3.o: $(SRC)/usr/src/cmd/tp/tp3.c $(SRC)/usr/src/cmd/tp/tp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/tp/tp3.c
