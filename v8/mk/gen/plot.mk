...
#     make -f $SRC/mk/gen/plot.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/plot -I$(INCDIR)
...
plot: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libcurses.a $(DESTDIR)/usr/lib/libtermcap.a
	$(CC) $(CFLAGS) -o plot $(OBJS) $(DESTDIR)/usr/lib/libcurses.a $(DESTDIR)/usr/lib/libtermcap.a $(LIBC)

driver.o: $(SRC)/usr/src/cmd/plot/driver.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/plot/driver.c

install: plot
	-mkdir $(DESTDIR)/usr/bin
	cp plot $(DESTDIR)/usr/bin/plot
