...
#     make -f $SRC/mk/gen/finddev.mk TOOLDIR=... install
#
...
finddev: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o finddev $(OBJS) $(LIBC)

finddev.o: $(SRC)/usr/src/cmd/finddev.c $(INCDIR)/ctype.h $(INCDIR)/errno.h $(INCDIR)/ftw.h $(INCDIR)/nlist.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/dmap.h $(INCDIR)/sys/file.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/pcb.h $(INCDIR)/sys/proc.h $(INCDIR)/sys/pte.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/text.h $(INCDIR)/sys/types.h $(INCDIR)/sys/user.h $(INCDIR)/sys/vm.h $(INCDIR)/sys/vmmac.h $(INCDIR)/sys/vmmeter.h $(INCDIR)/sys/vmparam.h $(INCDIR)/sys/vmsystm.h $(INCDIR)/sys/vtimes.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/finddev.c

install: finddev
	-mkdir $(DESTDIR)/etc
	cp finddev $(DESTDIR)/etc/finddev
