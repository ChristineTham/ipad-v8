...
#     make -f $SRC/mk/gen/fsck.mk TOOLDIR=... install
#
...
fsck.o: $(SRC)/usr/src/cmd/fsck.c $(INCDIR)/ctype.h $(INCDIR)/fstab.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/fblk.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/fsck.c
