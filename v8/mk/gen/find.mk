...
#     make -f $SRC/mk/gen/find.mk TOOLDIR=... install
#
...
find.o: $(SRC)/usr/src/cmd/find.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
