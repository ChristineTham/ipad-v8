...
#     make -f $SRC/mk/gen/vmstat.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/vmstat -I$(INCDIR)
...
vmstat: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o vmstat $(OBJS) $(LIBC)

vmstat.o: $(SRC)/usr/src/cmd/vmstat/vmstat.c $(INCDIR)/nlist.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/buf.h $(INCDIR)/sys/dk.h $(INCDIR)/sys/mbavar.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(INCDIR)/sys/ubavar.h $(INCDIR)/sys/vm.h $(INCDIR)/sys/vmmac.h $(INCDIR)/sys/vmmeter.h $(INCDIR)/sys/vmparam.h $(INCDIR)/sys/vmsystm.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/vmstat/vmstat.c

install: vmstat
	-mkdir $(DESTDIR)/bin
	cp vmstat $(DESTDIR)/bin/vmstat
