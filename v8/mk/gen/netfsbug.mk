...
#     make -f $SRC/mk/gen/netfsbug.mk TOOLDIR=... install
#
...
netfsbug: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o netfsbug $(OBJS) $(LIBC)

netfsbug.o: $(SRC)/usr/src/cmd/netfsbug.c $(INCDIR)/nlist.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/neta.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
