...
#     make -f $SRC/mk/gen/passwd.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/passwd -I$(INCDIR)
...
passwd: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o passwd $(OBJS) $(LIBC)

passwd.o: $(SRC)/usr/src/cmd/passwd/passwd.c $(INCDIR)/ctype.h $(INCDIR)/errno.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/passwd/passwd.c

install: passwd
	-mkdir $(DESTDIR)/bin
	cp passwd $(DESTDIR)/bin/passwd
