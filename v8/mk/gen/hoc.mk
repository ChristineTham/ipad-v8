...
#     make -f $SRC/mk/gen/hoc.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I. -I$(SRC)/usr/src/cmd/hoc -I$(INCDIR)
...
hoc: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o hoc $(OBJS) $(LIBC)

y.tab.c: $(SRC)/usr/src/cmd/hoc/hoc.y $(YACCPATH) $(INCDIR)/ctype.h $(INCDIR)/errno.h $(INCDIR)/setjmp.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/hoc/hoc.h
	$(YACC) -d $(SRC)/usr/src/cmd/hoc/hoc.y
...
math.o: $(SRC)/usr/src/cmd/hoc/math.c $(INCDIR)/errno.h $(INCDIR)/math.h y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/hoc/math.c

symbol.o: $(SRC)/usr/src/cmd/hoc/symbol.c $(SRC)/usr/src/cmd/hoc/hoc.h y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/hoc/symbol.c
