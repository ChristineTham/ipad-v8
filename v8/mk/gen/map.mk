...
#     make -f $SRC/mk/gen/map.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/map -I$(INCDIR)
...
map: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libplot.a
	$(CC) $(CFLAGS) -o map $(OBJS) $(DESTDIR)/usr/lib/libplot.a $(LIBC)

map.o: $(SRC)/usr/src/cmd/map/map.c $(INCDIR)/iplot.h $(INCDIR)/math.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/map/map.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/map/map.c

install: map
	-mkdir $(DESTDIR)/usr/bin
	cp map $(DESTDIR)/usr/bin/map
