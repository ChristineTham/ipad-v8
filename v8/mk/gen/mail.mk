...
#     make -f $SRC/mk/gen/mail.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/mail -I$(INCDIR)
...
mail: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o mail $(OBJS) $(LIBC)

mail.o: $(SRC)/usr/src/cmd/mail/mail.c $(INCDIR)/ctype.h $(INCDIR)/dir.h $(INCDIR)/grp.h $(INCDIR)/pwd.h $(INCDIR)/setjmp.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/timeb.h $(INCDIR)/sys/types.h $(INCDIR)/time.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/mail/mail.c

install: mail
	-mkdir $(DESTDIR)/bin
	cp mail $(DESTDIR)/bin/mail
