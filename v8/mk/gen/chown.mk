...
#     make -f $SRC/mk/gen/chown.mk TOOLDIR=... install
#
...
chown: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o chown $(OBJS) $(LIBC)

chown.o: $(SRC)/usr/src/cmd/chown.c $(INCDIR)/ctype.h $(INCDIR)/grp.h $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/chown.c

install: chown
	-mkdir $(DESTDIR)/etc
	cp chown $(DESTDIR)/etc/chown
