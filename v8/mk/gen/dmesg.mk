...
#     make -f $SRC/mk/gen/dmesg.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/dmesg -I$(INCDIR)
...
dmesg: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o dmesg $(OBJS) $(LIBC)

dmesg.o: $(SRC)/usr/src/cmd/dmesg/dmesg.c $(INCDIR)/nlist.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/msgbuf.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(INCDIR)/sys/vm.h $(INCDIR)/sys/vmmac.h $(INCDIR)/sys/vmmeter.h $(INCDIR)/sys/vmparam.h $(INCDIR)/sys/vmsystm.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/dmesg/dmesg.c

install: dmesg
	-mkdir $(DESTDIR)/etc
	cp dmesg $(DESTDIR)/etc/dmesg
