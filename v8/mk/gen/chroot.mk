...
#     make -f $SRC/mk/gen/chroot.mk TOOLDIR=... install
#
...
chroot: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o chroot $(OBJS) $(LIBC)

chroot.o: $(SRC)/usr/src/cmd/chroot.c $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/chroot.c

install: chroot
	-mkdir $(DESTDIR)/etc
	cp chroot $(DESTDIR)/etc/chroot
