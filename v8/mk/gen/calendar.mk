...
#     make -f $SRC/mk/gen/calendar.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/calendar -I$(INCDIR)
COMPILE = $(CC) $(CFLAGS) $(INCS) -c
TOOLS  = $(CCPATH) $(CCOM) $(CPP) $(C2) $(AS)

OBJS = calendar1.o calendar2.o calendar4.o

all: calendar

calendar: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o calendar $(OBJS) $(LIBC)

calendar1.o: $(SRC)/usr/src/cmd/calendar/calendar1.c $(INCDIR)/pwd.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/calendar/calendar1.c

calendar2.o: $(SRC)/usr/src/cmd/calendar/calendar2.c $(INCDIR)/time.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/calendar/calendar2.c

calendar4.o: $(SRC)/usr/src/cmd/calendar/calendar4.c $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/calendar/calendar4.c

install: calendar
	-mkdir $(DESTDIR)/usr/bin
	cp calendar $(DESTDIR)/usr/bin/calendar
