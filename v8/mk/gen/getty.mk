...
#     make -f $SRC/mk/gen/getty.mk TOOLDIR=... install
#
...
getty.o: $(SRC)/usr/src/cmd/getty.c $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(INCDIR)/sys/utsname.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/getty.c
