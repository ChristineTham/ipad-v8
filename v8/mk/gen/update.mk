...
#     make -f $SRC/mk/gen/update.mk TOOLDIR=... install
#
...
update: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o update $(OBJS) $(LIBC)

update.o: $(SRC)/usr/src/cmd/update.c $(INCDIR)/signal.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/update.c

install: update
	-mkdir $(DESTDIR)/etc
	cp update $(DESTDIR)/etc/update
