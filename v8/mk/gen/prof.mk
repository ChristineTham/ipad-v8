...
#     make -f $SRC/mk/gen/prof.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/prof -I$(INCDIR)
...
prof: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o prof $(OBJS) $(LIBC)

prof.o: $(SRC)/usr/src/cmd/prof/prof.c $(INCDIR)/a.out.h $(INCDIR)/iplot.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
