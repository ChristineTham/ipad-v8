...
#     make -f $SRC/mk/gen/tsort.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/tsort -I$(INCDIR)
COMPILE = $(CC) $(CFLAGS) $(INCS) -c
TOOLS  = $(CCPATH) $(CCOM) $(CPP) $(C2) $(AS)

OBJS = refstore.o subs.o tsort.o

all: tsort

tsort: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o tsort $(OBJS) $(LIBC)

refstore.o: $(SRC)/usr/src/cmd/tsort/refstore.c $(SRC)/usr/src/cmd/tsort/ts.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/tsort/refstore.c

subs.o: $(SRC)/usr/src/cmd/tsort/subs.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/tsort/ts.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/tsort/subs.c

tsort.o: $(SRC)/usr/src/cmd/tsort/tsort.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/tsort/ts.h $(TOOLS)
