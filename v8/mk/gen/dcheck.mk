...
#     make -f $SRC/mk/gen/dcheck.mk TOOLDIR=... install
#
...
dcheck: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o dcheck $(OBJS) $(LIBC)

dcheck.o: $(SRC)/usr/src/cmd/dcheck.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/fblk.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/dcheck.c

install: dcheck
	-mkdir $(DESTDIR)/etc
	cp dcheck $(DESTDIR)/etc/dcheck
