...
#     make -f $SRC/mk/gen/cc.mk TOOLDIR=... install
#
...
cc.o: cc.c $(INCDIR)/ctype.h $(INCDIR)/dir.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) cc.c

install: cc
	-mkdir $(TOOLDIR)/bin
	cp cc $(TOOLDIR)/bin/cc
