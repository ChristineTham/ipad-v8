...
#     make -f $SRC/mk/gen/ratfor.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I. -I$(SRC)/usr/src/cmd/ratfor -I$(INCDIR)
COMPILE = $(CC) $(CFLAGS) $(INCS) -c
TOOLS  = $(CCPATH) $(CCOM) $(CPP) $(C2) $(AS)

OBJS = r0.o r1.o r2.o rio.o rlex.o rlook.o y.tab.o

all: ratfor

ratfor: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o ratfor $(OBJS) $(LIBC)

y.tab.c: $(SRC)/usr/src/cmd/ratfor/r.g $(YACCPATH) 
	$(YACC) -d $(SRC)/usr/src/cmd/ratfor/r.g

# written by the y.tab.c rule above
y.tab.h: y.tab.c
	@echo y.tab.h

r0.o: $(SRC)/usr/src/cmd/ratfor/r0.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/ratfor/r.h y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ratfor/r0.c

r1.o: $(SRC)/usr/src/cmd/ratfor/r1.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/ratfor/r.h y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ratfor/r1.c

r2.o: $(SRC)/usr/src/cmd/ratfor/r2.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/ratfor/r.h y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ratfor/r2.c

rio.o: $(SRC)/usr/src/cmd/ratfor/rio.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/ratfor/r.h y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ratfor/rio.c

rlex.o: $(SRC)/usr/src/cmd/ratfor/rlex.c $(INCDIR)/ctype.h $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/ratfor/r.h y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ratfor/rlex.c

rlook.o: $(SRC)/usr/src/cmd/ratfor/rlook.c y.tab.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ratfor/rlook.c
