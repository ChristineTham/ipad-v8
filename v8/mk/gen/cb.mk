...
#     make -f $SRC/mk/gen/cb.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/cb -I$(INCDIR)
...
cb: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o cb $(OBJS) $(LIBC)

cb.o: $(SRC)/usr/src/cmd/cb/cb.c $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/cb/cbtype.c $(SRC)/usr/src/cmd/cb/cbtype.h $(TOOLS)
