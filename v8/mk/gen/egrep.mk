...
#     make -f $SRC/mk/gen/egrep.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I. -I$(SRC)/usr/src/cmd -I$(INCDIR)
...
egrep: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o egrep $(OBJS) $(LIBC)

y.tab.c: $(SRC)/usr/src/cmd/egrep.y $(YACCPATH) $(INCDIR)/ctype.h $(INCDIR)/stdio.h
	$(YACC) $(SRC)/usr/src/cmd/egrep.y
