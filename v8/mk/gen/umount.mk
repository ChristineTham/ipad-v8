...
#     make -f $SRC/mk/gen/umount.mk TOOLDIR=... install
#
...
umount.o: $(SRC)/usr/src/cmd/umount.c $(INCDIR)/errno.h $(INCDIR)/fstab.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/umount.c
