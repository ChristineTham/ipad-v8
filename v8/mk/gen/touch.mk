...
#     make -f $SRC/mk/gen/touch.mk TOOLDIR=... install
#
...
touch: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o touch $(OBJS) $(LIBC)

touch.o: $(SRC)/usr/src/cmd/touch.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
