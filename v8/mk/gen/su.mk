...
#     make -f $SRC/mk/gen/su.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/su -I$(INCDIR)
...
su: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o su $(OBJS) $(LIBC)

su.o: $(SRC)/usr/src/cmd/su/su.c $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/time.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/su/su.c

install: su
	-mkdir $(DESTDIR)/etc
	cp su $(DESTDIR)/etc/su
