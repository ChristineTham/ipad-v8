...
#     make -f $SRC/mk/gen/ct.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/ct -I$(INCDIR)
...
ct: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libjobs.a
	$(CC) $(CFLAGS) -o ct $(OBJS) $(DESTDIR)/usr/lib/libjobs.a $(LIBC)

ct.o: $(SRC)/usr/src/cmd/ct/ct.c $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(INCDIR)/utmp.h $(TOOLS)
