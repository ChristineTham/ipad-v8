...
#     make -f $SRC/mk/gen/cpio.mk TOOLDIR=... install
#
...
cpio.o: $(SRC)/usr/src/cmd/cpio.c $(INCDIR)/pwd.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
