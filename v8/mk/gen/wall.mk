...
#     make -f $SRC/mk/gen/wall.mk TOOLDIR=... install
#
...
wall: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o wall $(OBJS) $(LIBC)

wall.o: $(SRC)/usr/src/cmd/wall.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/sys/utsname.h $(INCDIR)/time.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/wall.c

install: wall
	-mkdir $(DESTDIR)/etc
	cp wall $(DESTDIR)/etc/wall
