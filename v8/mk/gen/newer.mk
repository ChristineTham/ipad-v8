...
#     make -f $SRC/mk/gen/newer.mk TOOLDIR=... install
#
...
newer: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o newer $(OBJS) $(LIBC)

newer.o: $(SRC)/usr/src/cmd/newer.c $(INCDIR)/signal.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
