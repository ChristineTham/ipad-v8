...
#     make -f $SRC/mk/gen/factor.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/factor -I$(INCDIR)
...
factor: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o factor $(OBJS) $(LIBC)

factor.o: $(SRC)/usr/src/cmd/factor/factor.c $(INCDIR)/math.h $(TOOLS)
