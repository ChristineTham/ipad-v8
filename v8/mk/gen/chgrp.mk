...
#     make -f $SRC/mk/gen/chgrp.mk TOOLDIR=... install
#
...
chgrp: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o chgrp $(OBJS) $(LIBC)

chgrp.o: $(SRC)/usr/src/cmd/chgrp.c $(INCDIR)/ctype.h $(INCDIR)/grp.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/chgrp.c

install: chgrp
	-mkdir $(DESTDIR)/etc
	cp chgrp $(DESTDIR)/etc/chgrp
