...
#     make -f $SRC/mk/gen/ncheck.mk TOOLDIR=... install
#
...
ncheck: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o ncheck $(OBJS) $(LIBC)

ncheck.o: $(SRC)/usr/src/cmd/ncheck.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/fblk.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ncheck.c

install: ncheck
	-mkdir $(DESTDIR)/etc
	cp ncheck $(DESTDIR)/etc/ncheck
