...
#     make -f $SRC/mk/gen/cp.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/cp -I$(INCDIR)
...
cp.o: $(SRC)/usr/src/cmd/cp/cp.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/cp/cp.c
