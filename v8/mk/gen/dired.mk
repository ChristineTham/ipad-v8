...
#     make -f $SRC/mk/gen/dired.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/dired -I$(INCDIR)
...
dired: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libtermcap.a
	$(CC) $(CFLAGS) -o dired $(OBJS) $(DESTDIR)/usr/lib/libtermcap.a $(LIBC)

dired.o: $(SRC)/usr/src/cmd/dired/dired.c $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
