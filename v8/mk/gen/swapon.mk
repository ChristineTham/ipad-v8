...
#     make -f $SRC/mk/gen/swapon.mk TOOLDIR=... install
#
...
swapon: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o swapon $(OBJS) $(LIBC)

swapon.o: $(SRC)/usr/src/cmd/swapon.c $(INCDIR)/fstab.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/swapon.c

install: swapon
	-mkdir $(DESTDIR)/etc
	cp swapon $(DESTDIR)/etc/swapon
