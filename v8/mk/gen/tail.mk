...
#     make -f $SRC/mk/gen/tail.mk TOOLDIR=... install
#
...
tail.o: $(SRC)/usr/src/cmd/tail.c $(INCDIR)/ctype.h $(INCDIR)/errno.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
