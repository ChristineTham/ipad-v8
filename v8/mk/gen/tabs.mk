...
#     make -f $SRC/mk/gen/tabs.mk TOOLDIR=... install
#
...
tabs: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o tabs $(OBJS) $(LIBC)

tabs.o: $(SRC)/usr/src/cmd/tabs.c $(INCDIR)/sgtty.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/ioctl.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
