...
#     make -f $SRC/mk/gen/last.mk TOOLDIR=... install
#
...
last: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o last $(OBJS) $(LIBC)

last.o: $(SRC)/usr/src/cmd/last.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/utmp.h $(TOOLS)
