...
#     make -f $SRC/mk/gen/diff.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/diff -I$(INCDIR)
COMPILE = $(CC) $(CFLAGS) $(INCS) -c
TOOLS  = $(CCPATH) $(CCOM) $(CPP) $(C2) $(AS)

OBJS = diff.o diffdir.o diffh.o diffreg.o

all: diff

diff: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o diff $(OBJS) $(LIBC)

diff.o: $(SRC)/usr/src/cmd/diff/diff.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(SRC)/usr/src/cmd/diff/diff.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/diff/diff.c

diffdir.o: $(SRC)/usr/src/cmd/diff/diffdir.c $(INCDIR)/a.out.h $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(SRC)/usr/src/cmd/diff/diff.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/diff/diffdir.c

diffh.o: $(SRC)/usr/src/cmd/diff/diffh.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/diff/diffh.c

diffreg.o: $(SRC)/usr/src/cmd/diff/diffreg.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(SRC)/usr/src/cmd/diff/diff.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/diff/diffreg.c
