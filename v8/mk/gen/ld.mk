...
ld.o: ld.c $(INCDIR)/a.out.h $(INCDIR)/ar.h $(INCDIR)/ctype.h $(INCDIR)/pagsiz.h $(INCDIR)/ranlib.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) ld.c
