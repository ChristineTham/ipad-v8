...
#     make -f $SRC/mk/gen/kill.mk TOOLDIR=... install
#
...
kill: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o kill $(OBJS) $(LIBC)

kill.o: $(SRC)/usr/src/cmd/kill.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/kill.c

install: kill
	-mkdir $(DESTDIR)/bin
	cp kill $(DESTDIR)/bin/kill
