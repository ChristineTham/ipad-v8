...
#     make -f $SRC/mk/gen/diff3.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/diff3 -I$(INCDIR)
...
diff3: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o diff3 $(OBJS) $(LIBC)

diff3.o: $(SRC)/usr/src/cmd/diff3/diff3.c $(INCDIR)/stdio.h $(TOOLS)
