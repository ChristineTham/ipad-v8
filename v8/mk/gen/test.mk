...
#     make -f $SRC/mk/gen/test.mk TOOLDIR=... install
#
...
test: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o test $(OBJS) $(LIBC)

test.o: $(SRC)/usr/src/cmd/test.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/test.c

install: test
	-mkdir $(DESTDIR)/bin
	cp test $(DESTDIR)/bin/test
