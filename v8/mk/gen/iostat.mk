...
#     make -f $SRC/mk/gen/iostat.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/iostat -I$(INCDIR)
...
iostat: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o iostat $(OBJS) $(LIBC)

iostat.o: $(SRC)/usr/src/cmd/iostat/iostat.c $(INCDIR)/nlist.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/buf.h $(INCDIR)/sys/dk.h $(INCDIR)/sys/mbavar.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(INCDIR)/sys/ubavar.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/iostat/iostat.c

install: iostat
	-mkdir $(DESTDIR)/bin
	cp iostat $(DESTDIR)/bin/iostat
