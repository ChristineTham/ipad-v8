...
#     make -f $SRC/mk/gen/rmdir.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/rmdir -I$(INCDIR)
...
rmdir: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o rmdir $(OBJS) $(LIBC)

rmdir.o: $(SRC)/usr/src/cmd/rmdir/rmdir.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/rmdir/rmdir.c

install: rmdir
	-mkdir $(DESTDIR)/bin
	cp rmdir $(DESTDIR)/bin/rmdir
