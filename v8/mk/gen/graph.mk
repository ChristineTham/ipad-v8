...
#     make -f $SRC/mk/gen/graph.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/graph -I$(INCDIR)
...
graph: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libplot.a
	$(CC) $(CFLAGS) -o graph $(OBJS) $(DESTDIR)/usr/lib/libplot.a $(LIBC)

graph.o: $(SRC)/usr/src/cmd/graph/graph.c $(INCDIR)/ctype.h $(INCDIR)/iplot.h $(INCDIR)/math.h $(INCDIR)/stdio.h $(TOOLS)
