...
#     make -f $SRC/mk/gen/write.mk TOOLDIR=... install
#
...
write: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o write $(OBJS) $(LIBC)

write.o: $(SRC)/usr/src/cmd/write.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/sys/utsname.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/write.c

install: write
	-mkdir $(DESTDIR)/bin
	cp write $(DESTDIR)/bin/write
