...
#     make -f $SRC/mk/gen/restor.mk TOOLDIR=... install
#
...
restor: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o restor $(OBJS) $(LIBC)

restor.o: $(SRC)/usr/src/cmd/restor.c $(INCDIR)/dumprestor.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/fblk.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/ino.h $(INCDIR)/sys/inode.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/restor.c

install: restor
	-mkdir $(DESTDIR)/etc
	cp restor $(DESTDIR)/etc/restor
