...
#     make -f $SRC/mk/gen/od.mk TOOLDIR=... install
#
...
od: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o od $(OBJS) $(LIBC)

od.o: $(SRC)/usr/src/cmd/od.c $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/od.c

install: od
	-mkdir $(DESTDIR)/bin
	cp od $(DESTDIR)/bin/od
