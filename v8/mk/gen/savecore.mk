...
#     make -f $SRC/mk/gen/savecore.mk TOOLDIR=... install
#
...
savecore: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o savecore $(OBJS) $(LIBC)

savecore.o: $(SRC)/usr/src/cmd/savecore.c $(INCDIR)/nlist.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/dir.h $(INCDIR)/sys/filsys.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/time.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/savecore.c

install: savecore
	-mkdir $(DESTDIR)/etc
	cp savecore $(DESTDIR)/etc/savecore
