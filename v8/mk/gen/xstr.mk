...
#     make -f $SRC/mk/gen/xstr.mk TOOLDIR=... install
#
...
xstr: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o xstr $(OBJS) $(LIBC)

xstr.o: $(SRC)/usr/src/cmd/xstr.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
