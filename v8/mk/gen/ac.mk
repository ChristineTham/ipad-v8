...
#     make -f $SRC/mk/gen/ac.mk TOOLDIR=... install
#
...
ac: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o ac $(OBJS) $(LIBC)

ac.o: $(SRC)/usr/src/cmd/ac.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/timeb.h $(INCDIR)/sys/types.h $(INCDIR)/time.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/ac.c

install: ac
	-mkdir $(DESTDIR)/etc
	cp ac $(DESTDIR)/etc/ac
