...
#     make -f $SRC/mk/gen/sort.mk TOOLDIR=... install
#
...
sort: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o sort $(OBJS) $(LIBC)

sort.o: $(SRC)/usr/src/cmd/sort.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/sort.c

install: sort
	-mkdir $(DESTDIR)/usr
	-mkdir $(DESTDIR)/usr/bin
	cp sort $(DESTDIR)/usr/bin/sort
