...
#     make -f $SRC/mk/gen/date.mk TOOLDIR=... install
#
...
date.o: $(SRC)/usr/src/cmd/date.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/timeb.h $(INCDIR)/sys/types.h $(INCDIR)/time.h $(INCDIR)/utmp.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/date.c
