...
#     make -f $SRC/mk/gen/mkdir.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/mkdir -I$(INCDIR)
...
mkdir.o: $(SRC)/usr/src/cmd/mkdir/mkdir.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/mkdir/mkdir.c
