...
#     make -f $SRC/mk/gen/showq.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/showq -I$(INCDIR)
...
showq: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o showq $(OBJS) $(LIBC)

showq.o: $(SRC)/usr/src/cmd/showq/showq.c $(INCDIR)/ctype.h $(INCDIR)/nlist.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/showq/showq.c

install: showq
	-mkdir $(DESTDIR)/etc
	cp showq $(DESTDIR)/etc/showq
