...
#     make -f $SRC/mk/gen/mesg.mk TOOLDIR=... install
#
...
mesg: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o mesg $(OBJS) $(LIBC)

mesg.o: $(SRC)/usr/src/cmd/mesg.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
