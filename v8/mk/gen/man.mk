...
#     make -f $SRC/mk/gen/man.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I$(SRC)/usr/src/cmd/man -I$(INCDIR)
...
man: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o man $(OBJS) $(LIBC)

man.o: $(SRC)/usr/src/cmd/man/man.c $(INCDIR)/signal.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/time.h $(TOOLS)
