...
#     make -f $SRC/mk/gen/pp.mk TOOLDIR=... install
#
...
CFLAGS = -O 
INCS   = -I. -I$(SRC)/usr/src/cmd/pp -I$(INCDIR)
...
pp: $(OBJS) $(LD) $(LIBC) $(DESTDIR)/usr/lib/libl.a
	$(CC) $(CFLAGS) -o pp $(OBJS) $(DESTDIR)/usr/lib/libl.a $(LIBC)

lex.yy.c: $(SRC)/usr/src/cmd/pp/scan.l $(LEXPATH) $(INCDIR)/stdio.h $(SRC)/usr/src/cmd/pp/pp.h
	$(LEX) $(SRC)/usr/src/cmd/pp/scan.l

lex.yy.o: lex.yy.c $(TOOLS)
	$(COMPILE) lex.yy.c
