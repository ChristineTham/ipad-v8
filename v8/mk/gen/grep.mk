...
#     make -f $SRC/mk/gen/grep.mk TOOLDIR=... install
#
...
grep.o: $(SRC)/usr/src/cmd/grep.c $(INCDIR)/ctype.h $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/types.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/grep.c
