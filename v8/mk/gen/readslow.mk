...
#     make -f $SRC/mk/gen/readslow.mk TOOLDIR=... install
#
...
readslow: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o readslow $(OBJS) $(LIBC)

readslow.o: $(SRC)/usr/src/cmd/readslow.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(TOOLS)
