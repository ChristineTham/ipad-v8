...
#     make -f $SRC/mk/gen/basename.mk TOOLDIR=... install
#
...
basename: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o basename $(OBJS) $(LIBC)

basename.o: $(SRC)/usr/src/cmd/basename.c $(INCDIR)/stdio.h $(TOOLS)
