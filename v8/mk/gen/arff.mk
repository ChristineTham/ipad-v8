...
#     make -f $SRC/mk/gen/arff.mk TOOLDIR=... install
#
...
arff: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o arff $(OBJS) $(LIBC)

arff.o: $(SRC)/usr/src/cmd/arff.c $(INCDIR)/signal.h $(INCDIR)/stdio.h $(INCDIR)/sys/param.h $(INCDIR)/sys/stat.h $(INCDIR)/sys/types.h $(INCDIR)/time.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/arff.c

install: arff
	-mkdir $(DESTDIR)/bin
	cp arff $(DESTDIR)/bin/arff
