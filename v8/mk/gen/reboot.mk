...
#     make -f $SRC/mk/gen/reboot.mk TOOLDIR=... install
#
...
reboot: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o reboot $(OBJS) $(LIBC)

reboot.o: $(SRC)/usr/src/cmd/reboot.c $(INCDIR)/stdio.h $(INCDIR)/sys/reboot.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/reboot.c

install: reboot
	-mkdir $(DESTDIR)/etc
	cp reboot $(DESTDIR)/etc/reboot
