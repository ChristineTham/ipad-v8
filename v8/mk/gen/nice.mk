...
#     make -f $SRC/mk/gen/nice.mk TOOLDIR=... install
#
...
nice: $(OBJS) $(LD) $(LIBC)
	$(CC) $(CFLAGS) -o nice $(OBJS) $(LIBC)

nice.o: $(SRC)/usr/src/cmd/nice.c $(INCDIR)/stdio.h $(TOOLS)
	$(COMPILE) $(SRC)/usr/src/cmd/nice.c

install: nice
	-mkdir $(DESTDIR)/bin
	cp nice $(DESTDIR)/bin/nice
